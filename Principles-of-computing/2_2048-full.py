"""
http://www.codeskulptor.org/#user41_kMMVRTmSRa_12.py
Score 77/100, cannot solve the print out str with new title
[-15.0 pts] For obj = TwentyFortyEight(2, 2), obj.reset() expected
[[0, 0]
 [0, 0]]
with 2 new tile(s)
